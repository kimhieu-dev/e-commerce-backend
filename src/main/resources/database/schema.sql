...
VALUES ('01a8fbde-c054-4e45-89c6-111034e322bc', 'ABCSSS111', 'Vua ko ngai', 2223.88, '', 'ACTIVE',
        '2026-05-04 17:31:45', '2026-05-04 17:31:45', 'sieunhan11', 'sieunhan11', 0),
       ('39268869-8331-477a-bab6-acb51578dc35', 'DKdsD1', 'Mu coi', 9223.88, '', 'ACTIVE', '2026-05-04 17:31:17',
        '2026-05-04 17:31:17', 'sieunhan11', 'sieunhan11', 0),
       ('525195c9-49b9-415b-9f88-ef24cc67e496', 'SKU-010', 'King von', 99.99, '', 'ACTIVE', '2026-05-03 00:14:36',
        '2026-05-03 00:14:36', 'sieunhan11', 'sieunhan11', 0),
       ('55ed6816-5b0d-49aa-a6ec-7ce100fd46b2', 'DHKK174', 'Dep tong', 94.88, '', 'ACTIVE', '2026-05-04 17:30:28',
        '2026-05-04 17:30:28', 'sieunhan11', 'sieunhan11', 0),
       ('6829f4e1-c031-4322-aac4-42a2d9519c5a', 'SKU-0111', 'Test Product', 99.99, '', 'ACTIVE', '2026-05-03 01:12:57',
        '2026-05-03 01:12:57', 'sieunhan11', 'sieunhan11', 0),
       ('6e3de641-b8a1-4fc0-8a8d-4114fe995ab1', 'DHKK1244', 'Tu lanh khi', 84.88, '', 'ACTIVE', '2026-05-04 17:29:26',
        '2026-05-04 17:29:26', 'sieunhan11', 'sieunhan11', 0),
       ('6ed68775-c740-44ca-86d4-2efdee61e57c', 'SKU-0101', 'Test Product', 99.99, '', 'ACTIVE', '2026-05-03 01:12:44',
        '2026-05-03 01:12:44', 'sieunhan11', 'sieunhan11', 0),
       ('76ca6748-1e41-4887-b1f9-726e480cb321', 'ABC123', 'ABC', 130000000.23, 'url/example', 'ACTIVE',
        '2026-05-02 14:13:25', '2026-05-02 14:13:25', 'SYSTEM', 'SYSTEM', 0),
       ('8be8b38a-149e-49e5-b6e5-0a628973c04c', 'DHKK1234', 'Dieu hoa khong khi', 88.88, '', 'ACTIVE',
        '2026-05-04 16:04:02', '2026-05-04 16:04:02', 'sieunhan11', 'sieunhan11', 0),
       ('a01b5a18-d63c-485c-8a5e-73dbdd960d12', 'Prod123', 'Test Product', 99.99, '', 'ACTIVE', '2026-05-03 01:29:19',
        '2026-05-03 01:29:19', 'sieunhan11', 'sieunhan11', 0),
       ('ac66eacd-d486-408e-a293-55e84e546f99', 'SKU-0211', 'Test Product', 99.99, '', 'ACTIVE', '2026-05-03 01:13:12',
        '2026-05-03 01:13:12', 'sieunhan11', 'sieunhan11', 0),
       ('b36ef438-0c96-4ecb-8bb6-a1f9395101bd', 'SKU-001', 'Test Product', 99.99, '', 'ACTIVE', '2026-05-03 00:03:45',
        '2026-05-03 00:11:46', 'sieunhan11', 'sieunhan11', 0),
       ('bbb7353b-a9d7-48a5-8c5e-1488c812e2e7', 'DKDSA11', 'Mu coi', 922.88, '', 'ACTIVE', '2026-05-04 17:30:54',
        '2026-05-04 17:30:54', 'sieunhan11', 'sieunhan11', 0),
       ('fcac3677-a0f7-4ed0-80f7-d39030042904', 'DHKK1224', 'Giay dep', 94.88, '', 'ACTIVE', '2026-05-04 17:30:14',
...
VALUES ('07d459a5-5df8-4644-825d-032d00dc4660', '8be8b38a-149e-49e5-b6e5-0a628973c04c', 'mat lanh', 1.50, 10.00, 5.00,
       ...
       ('f07e8153-d8cd-4ebd-aaa7-1b334c37972a', '65a4da9a-6cf1-4f4b-8dd9-500de3c719f5', '', 1.50, 10.00, 5.00, 3.00,
        '2026-05-03 00:10:08', '2026-05-03 00:10:08', 'sieunhan11', 'sieunhan11', 0),
...
(
    ...
    `status`             enum ('PENDING','CONFIRMED','REJECTED','PICKING','SHIPPING','DELIVERED','FAILED','RETURNING') NOT NULL,
    `payment_status`     enum ('AWAITING_PAYMENT','PAID','UNPAID','REFUNDED','FAILED') DEFAULT 'AWAITING_PAYMENT',
    ...
    `deleted`            tinyint(1)                                                    DEFAULT '0',
    PRIMARY KEY (`id`),
    UNIQUE KEY `order_pk_2` (`id`),
    UNIQUE KEY `order_pk_3` (`tracking_number`),
    KEY `user_id` (`user_id`),
    ...
    CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`carrier_id`) REFERENCES `carriers` (`id`),
    CONSTRAINT `orders_ibfk_4` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`)
);
...
VALUES ('095c7ddd-66ff-4c9b-ab70-6df616ef3929', '4d065b69-d5b1-421f-b53d-d291ae284367',
        'b36ef438-0c96-4ecb-8bb6-a1f9395101bd', 1, 0, '2026-05-04 17:35:36', '2026-05-04 17:35:36', 'sieunhan11',
        'sieunhan11', 0),
       ('0bb200c6-91b5-4d82-a160-f4db6aea03d5', '4d065b69-d5b1-421f-b53d-d291ae284367',
        '8be8b38a-149e-49e5-b6e5-0a628973c04c', 29, 0, '2026-05-04 17:34:39', '2026-05-04 17:34:39', 'sieunhan11',
        'sieunhan11', 0),
       ('14351701-5d14-4051-96bb-7e92ee97ec01', '4d065b69-d5b1-421f-b53d-d291ae284367',
        'fcac3677-a0f7-4ed0-80f7-d39030042904', 10, 0, '2026-05-04 17:35:57', '2026-05-09 11:35:06', 'sieunhan11',
        'sieunhan11', 1),
       ('1eb1bd9f-285f-4344-87e7-814fab31bbd6', '4d065b69-d5b1-421f-b53d-d291ae284367',
        '76ca6748-1e41-4887-b1f9-726e480cb321', 2, 1, '2026-05-02 14:21:35', '2026-05-09 11:33:37', 'sieunhan11',
        'sieunhan11', 0),
       ('46269688-7cdd-43a3-b125-d9c844522020', '4d065b69-d5b1-421f-b53d-d291ae284367',
        'a01b5a18-d63c-485c-8a5e-73dbdd960d12', 4, 0, '2026-05-03 01:31:41', '2026-05-09 11:33:37', 'sieunhan11',
        'sieunhan11', 1),
       ('8e5103a8-0348-47d9-8904-ab33bbbc2591', '4d065b69-d5b1-421f-b53d-d291ae284367',
        '6ed68775-c740-44ca-86d4-2efdee61e57c', 9, 0, '2026-05-04 17:36:16', '2026-05-04 17:36:16', 'sieunhan11',
        'sieunhan11', 0),
       ('ab6ee87e-935c-4b2b-8b51-c7393d5703c3', '4d065b69-d5b1-421f-b53d-d291ae284367',
        '55ed6816-5b0d-49aa-a6ec-7ce100fd46b2', 95, 0, '2026-05-04 17:36:48', '2026-05-04 17:36:48', 'sieunhan11',
        'sieunhan11', 0),
       ('ae4392f2-10f6-4d7c-9703-817d2d6af693', '4d065b69-d5b1-421f-b53d-d291ae284367',
        '525195c9-49b9-415b-9f88-ef24cc67e496', 10, 0, '2026-05-04 17:37:04', '2026-05-04 17:37:04', 'sieunhan11',
        'sieunhan11', 0),
       ('b99a821a-a345-4389-8437-e397d6e856b0', '4d065b69-d5b1-421f-b53d-d291ae284367',
        '6e3de641-b8a1-4fc0-8a8d-4114fe995ab1', 90, 0, '2026-05-04 17:36:27', '2026-05-04 17:36:27', 'sieunhan11',
        'sieunhan11', 0),
       ('d4440c2d-5767-47e3-b31b-b96d9208a14d', '4d065b69-d5b1-421f-b53d-d291ae284367',
        '6829f4e1-c031-4322-aac4-42a2d9519c5a', 95, 0, '2026-05-04 17:36:40', '2026-05-04 17:36:40', 'sieunhan11',
        'sieunhan11', 0),
       ('da97bda3-a7af-4d40-9991-81621e29bfa8', '4d065b69-d5b1-421f-b53d-d291ae284367',
        '39268869-8331-477a-bab6-acb51578dc35', 23, 0, '2026-05-04 17:37:16', '2026-05-04 17:37:27', 'sieunhan11',
        'sieunhan11', 0),
       ('e0dc9da8-36c2-48d1-a38c-e743e557db65', '4d065b69-d5b1-421f-b53d-d291ae284367',
        'bbb7353b-a9d7-48a5-8c5e-1488c812e2e7', 10, 0, '2026-05-04 17:35:47', '2026-05-04 17:35:47', 'sieunhan11',
        'sieunhan11', 0);
...
(
    ...
    `status`            enum ('IN_STOCK','LIMITED_STOCK','OUT_OF_STOCK') DEFAULT NULL,
...
CREATE TABLE `tracking_logs` (
                                 ...
                                 PRIMARY KEY (`id`),
                                 KEY `order_id` (`order_id`),
                                 CONSTRAINT `tracking_logs_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`)
);
